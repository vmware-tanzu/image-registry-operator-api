...
func Convert_v1alpha1_Condition_To_v1_Condition(in *Condition, out *metav1.Condition, _ apiconversion.Scope) error {
...
func Convert_v1_Condition_To_v1alpha1_Condition(in *metav1.Condition, out *Condition, _ apiconversion.Scope) error {
